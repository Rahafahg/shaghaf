              ...
              ClipRRect(
                ...
                child: SizedBox(
                  ...
                  child: workshop.image.isNotEmpty
                    ...
                    : Image.asset("assets/images/pasta_workshop.png"), // placeholder
                ),
              ),
              Positioned(
                top: 90,
              ...
              ClipRRect(
                ...
                child: SizedBox(
                  ...
                  child: SizedBox(
                    ...
                    child: workshop.image.isNotEmpty ? Image.network(
                        workshop.image,
                        fit: BoxFit.cover,
                        loadingBuilder: (context, child, loadingProgress) => loadingProgress==null? child : CircularProgressIndicator(),
                      )
                ...
                children: [
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            const Icon(Icons.star,size: 16, color: Colors.orange),
                            const SizedBox(width: 4),
                            Text(workshop.rating.toString(),style: Theme.of(context).textTheme.bodySmall),
                          ],
                        ),
                      ],
                    ),
                  ...
                  Row(
                    children: [
                      CircleAvatar(
                        radius: 12,
                        child: workshop.workshops.first.instructorImage.isNotEmpty
                        ? Image.network(
                        ...
                        : Image.asset("assets/images/default_organizer_image.png")
                      ),
                      const SizedBox(width: 4),
                      Text(
                        workshop.workshops.first.instructorName,
