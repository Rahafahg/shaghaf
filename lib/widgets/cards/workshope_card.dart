    ...
    return InkWell(
      ...
      child: shape == 'square' ? Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [BoxShadow(color: Colors.grey.shade300,blurRadius: 4,offset: const Offset(4, 2))]
        ),
        child: Stack(
          children: [
            ClipRRect(
            ...
            Positioned(
              ...
              left: 0,
              child: Container(
                decoration: const BoxDecoration(borderRadius:BorderRadius.all(Radius.circular(10.0)),color: Constants.cardColor),
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          const SizedBox(width: 4),
                          Text(rating,style: const TextStyle(fontFamily: "Poppins", fontSize: 8)),
                        ],
                      ),
                    ],
                  ),
                ...
                children: [
                  ...
                  Row(
                    children: [
                      CircleAvatar(
                        radius: 12,
                        child: Image.network(workshop.workshops.first.instructorImage,loadingBuilder: (context, child,loadingProgress) => loadingProgress == null ? child : Image.asset("assets/images/default_organizer_image.png"))
                      ),
                      const SizedBox(width: 4),
                      Text(
                  ...
                  SizedBox(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        isAttended == true ? SizedBox(
                          width: context.getWidth(divideBy: 7),
                          height: context.getHeight(divideBy: 27),
                          child: TextButton(
                            onPressed: ()=> ratingDialog(context: context,workshop: workshop),
                            style: TextButton.styleFrom(
                              foregroundColor: Constants.backgroundColor,
                              alignment: Alignment.center,
                              backgroundColor: const Color.fromARGB(149, 222, 101, 49),
                              side: const BorderSide(color: Constants.mainOrange),
                        ...
                        : Row(
                          children: [
                            const Icon(HugeIcons.strokeRoundedUser,size: 16,color: Constants.lightGreen),
                            const SizedBox(width: 4),
                            Text(
