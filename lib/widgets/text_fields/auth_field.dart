      ...
      children: [
        ...
        SizedBox(
          ...
          child: RichText(
            text: const TextSpan(
              children: [
                TextSpan(text: "Photo ", style: TextStyle(fontSize: 18, color: Constants.mainOrange, fontFamily: "Poppins", fontWeight: FontWeight.w600)),
                TextSpan(text: "(optional)", style: TextStyle(fontSize: 10, fontFamily: "Poppins", color: Constants.mainOrange))
              ]
            )
          )
        )
        : SizedBox(width: context.getWidth(),child: Text(type,style: const TextStyle(fontSize: 18, color: Constants.mainOrange, fontFamily: "Poppins", fontWeight: FontWeight.w600))),
        ...
        InkWell(
          ...
          child: TextFormField(
            ...
            decoration: const InputDecoration(
              ...
              hintStyle: TextStyle(fontSize: 14, fontFamily: "Poppins", color:  Color(0xff666666)),
