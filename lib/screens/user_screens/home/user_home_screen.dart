          ...
          child: Padding(
            ...
            child: AppBar(
              ...
              leading: Column(
                ...
                children: [
                  Text("Hello ${user?.firstName ?? 'guest'}",style: const TextStyle(fontSize: 16, color: Constants.lightOrange)),
                  const Text("Welcome to Shaghaf",style: TextStyle(fontSize: 16, color: Constants.mainOrange),),
                ],
              ),
            ),
          ),
                        ...
                        : Column(
                              ...
                              children: [
                                ...
                                Positioned(
                                  ...
                                  child: Row(
                                    children: [
                                      Text(
                                        workshopOfTheWeek.rating.toString(),
                                        style: const TextStyle(color: Constants.backgroundColor,fontSize: 16),
                                      ),
                          ...
                          GridView.builder(
                            ...
                            itemBuilder: (context, index) =>
                              WorkshopCard(
                                onTap: () => context.push(screen: WorkshopDetailScreen(workshop: workshops[index])),
